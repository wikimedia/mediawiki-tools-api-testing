...
class MagicConfig {
	 ...
	 *
	 * This method is called automatically via init() on the first access to a config
	 * property on the proxy object.
	 *
	 ...
	 * If config data was already loaded or otherwise defined, this does nothing.
	 ...
	 * variable. Otherwise, the config is expected to be placed in the base directory.
	 *
	 * @return {Object} the config proxy object
	 *
	 * @namespace api-testing
	 ...
	 * The new configuration will be reflected by the proxy object exported by the module.
	 ...
	 * This causes init() to re-load the configuration file the
	 * next time a config property is accessed.
	 *
	 * @namespace api-testing
	 */
	reset() {
	 ...
	 * Should be used together with reset() when testing the behavior of the proxy object.
	 *
	 * @param {string} dir
	 *
	 * @namespace api-testing
